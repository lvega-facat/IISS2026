...
class OrganizacionController extends Controller
{
    ...
    {
        return view('Modules.Organizacion.create');
    }
    ...
    public function edit()
    {
        ...
        return view('Modules.Organizacion.edit', compact('organizacion'));
    }
    ...
    public function destroy(
        ...
        return redirect()->route('organizacion.show')->with('success', 'Organización eliminada correctamente.');
    }
}