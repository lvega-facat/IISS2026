        ...
        <div class="table-responsive">
            <table class="module-table">
                ...
                <tbody>
                    ...
                    {{-- Ruta corregida apuntando a tu carpeta de componentes del módulo --}}
                    @include('Modules.Cargos.components.modal-eliminar', ['id' => 1, 'nombre' => 'Contador Senior'])
                    ...
                    @include('Modules.Cargos.components.modal-eliminar', ['id' => 2, 'nombre' => 'Desarrollador Backend'])
                    ...
                    @include('Modules.Cargos.components.modal-eliminar', ['id' => 3, 'nombre' => 'Diseñador UX/UI'])
                    ...
                    @include('Modules.Cargos.components.modal-eliminar', ['id' => 4, 'nombre' => 'Analista de Sistemas'])
